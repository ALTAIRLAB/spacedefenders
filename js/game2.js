function init() {
    ...
    function return_helpText() {
        return "Посылая друг другу радиосигналы, \nинопланетяне шифруют их в виде чисел. \nНаши самые великие математики \nнаучились расшифровывать эти \nсообщения. Но проблема в том, что \nинопланетяне разбивают каждое такое \nсообщение на 5 чисел и передают \nих по-отдельности. Поэтому, для \nдешифровки, сначала надо их сложить, а \nэто порой бывает очень сложно. Жаль, \nчто в свое время ученые не занимались \nментальной арифметикой, которая учит \nпроизводить операции над числами в уме \nи с большой скоростью. Тогда бы они с \nлегкостью складывали разъединенные \nшифры инопланетян в одно целое. Вам \nпридется помочь им в этом деле, иначе \nпоражение землян в этой войне \nпросто неизбежно.";
    }
