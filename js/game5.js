function init() {
    ...
    function return_help_text() {
        return "Мы смогли уничтожить все базы пришельцев, и теперь командование решило атаковать самое сердце \nврага – его родную планету. Сопровождая диверсионные отряды к этой планете, вы столкнулись с \nочередной проблемой – для того, чтобы преодолеть заградительные заслоны, нужно отправить пароль. \nПод паролем подразумевается ответ на зашифрованное сообщение. К счастью, техника шифрования \nинопланетян похожа на земную методику ментальной арифметики, а устройство шифрования по \nпринципу действия напоминает счеты абакус, благодаря чему расшифровка оказалась значительно \nпроще. Под видом поломки кораблей, произошедшей в недавней битве, наша армия смогла выиграть \nвремя, в течение которого Вам, при помощи абакуса, предстоит расшифровать все пароли каждого \nзаградительного заслона, используя данные, полученные из инструкций по методу шифрования на сайте: \n\n\nБез промедления изучите инструкции, приступайте к расшифровке и посылайте ответы капитанам \nкораблей. Будьте осторожны! Один неверный ответ, и вся миссия будет провалена. И помните, что, будучи \nключевой фигурой этой войны, на Вас возложена огромная задача – спасти Землю и оправдать надежду \nвсех жителей нашей планеты!";
    }
